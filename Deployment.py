...
model_path = r"C:\Users\seema\Desktop\Seema - Personal\Desktop\COURSE\360DigiTMG Course\Projects\Project_Team_119 - Intelligent Bar Counting\Pre-processing Code (Python)\Model Building Codes\YOLOV8x\YoloV8x Client Data\Building Real Time Tracking Code\best.pt"
# Setting page layout
st.set_page_config(
